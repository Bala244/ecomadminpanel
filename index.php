...
<main class="h-full pb-16 overflow-y-auto">
    <div class="container grid px-6 mx-auto">
        ...
        <div class="grid gap-6 mb-8 md:grid-cols-2 xl:grid-cols-4">
            ...
            <div class="flex items-center p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800">
                ...
                <div>
                    ...
                    <p class="text-lg font-semibold text-gray-700 dark:text-gray-200"><?php echo $total_user_count;?></p>
                </div>
            </div>
            ...
            <div class="flex items-center p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800">
                ...
                <div>
                    ...
                    <p class="text-lg font-semibold text-gray-700 dark:text-gray-200"><?php echo $total_product_count;?></p>
                </div>
            </div>

            <!-- Card -->
            <?php /* ?><div class="flex items-center p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800">
                    ...
                    <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                        <?php
                            ...
                            foreach($product_details as $product_detail){
                                ...
                                $db = getDbInstance();
                                $db->where('product_id', $product_detail['id']);
                                $product_images = $db->get('product_images');

                                $image_url = 'uploads/users/default.png';
                                if(count($product_images) > 0){
                                    $image_url = $product_images[0]['filepath'];
                                }
                                ...
                                $created_date = date_format(date_create($product_detail['created_at']), 'd-m-Y H:i:s');
                        ?>
                                    ...
                                    <td class="px-4 py-3">
                                        <div class="flex items-center text-sm">
                                            ...
                                            <!-- <div class="relative hidden w-8 h-8 mr-3 rounded-full md:block">
                                                <img class="object-cover w-full h-full rounded-full" src="<?php echo $image_url;?>" alt="" loading="lazy"/>
                                                <div class="absolute inset-0 rounded-full shadow-inner" aria-hidden="true"></div>
                                            </div> -->
                                            <div>
                                                <p class="font-semibold"><?php echo $product_detail['name'];?></p>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="px-4 py-3 text-sm"><?php echo $product_detail['sku_code'];?></td>
                                    <td class="px-4 py-3 text-sm"><?php echo $product_detail['quantity'];?></td>
                                    <td class="px-4 py-3 text-xs">
                                        <span class="px-2 py-1 font-semibold leading-tight text-green-700 bg-green-100 rounded-full dark:bg-green-700 dark:text-green-100">
                                            <?php echo $status;?>
                                        </span>
                                    </td>
                                    <td class="px-4 py-3 text-sm"><?php echo $created_date;?></td>
                                </tr>
                        ...
                        <?php /* ?><tr class="text-gray-700 dark:text-gray-400">
        ...
        <!-- Charts -->
        <?php /* ?><h2 class="my-6 text-2xl font-semibold text-gray-700 dark:text-gray-200">Charts</h2>
